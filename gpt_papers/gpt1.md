...
$$L_{1}(\mathcal{U})=\sum_{i} \log P\left(u_{i} \mid u_{i-k}, \ldots, u_{i-1} ; \Theta\right) \hspace{2cm}(1)$$ 
...
$$h_{l}=transformer\_block\left(h_{l-1}\right) \forall i \in[1{} , n] \hspace{2cm}(1)$$
