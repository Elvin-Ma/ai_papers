...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;为了表示逆向过程，我们使用类似于未屏蔽的PixelCNN++ [52, 48]的U-Net主干结构，并在整个过程中使用组归一化[66]。参数在时间上共享，并使用Transformer正弦位置嵌入[60]将时间信息输入网络。我们在16×16的特征图分辨率上使用自注意力机制[63, 60]。详细信息请参见附录B。<br>
