...
$$ \text{computed_time} = \frac {\text {total_computation}}{peak_{tp}}$$
$$𝑎𝑖𝑡 = \frac{\text{𝑡𝑜𝑡𝑎𝑙_𝑐𝑜𝑚𝑝𝑢𝑡𝑎𝑡𝑖𝑜𝑛}}{\text{𝑡𝑜𝑡𝑎𝑙_𝑑𝑎𝑡𝑎_𝑚𝑜𝑣𝑒𝑚𝑒𝑛t}}$$
$$ \text{𝑐𝑜𝑚𝑚𝑢𝑛𝑖𝑐𝑎𝑡𝑖𝑜𝑛_𝑡𝑖𝑚𝑒} = \frac{\text{𝑡𝑜𝑡𝑎𝑙_𝑑𝑎𝑡𝑎_𝑚𝑜𝑣𝑒𝑚𝑒𝑛𝑡}}{b} = \frac{\text{total_computation}}{𝑎𝑖𝑡 \times 𝑏}$$
$$𝑒𝑓𝑓𝑖𝑐𝑖𝑒𝑛𝑐𝑦 = \frac{\text{𝑐𝑜𝑚𝑝𝑢𝑡𝑒_𝑡𝑖𝑚𝑒}}{\text{𝑐𝑜𝑚𝑝𝑢𝑡𝑒_𝑡𝑖𝑚𝑒} + \text{𝑐𝑜𝑚𝑚𝑢𝑛𝑖𝑐𝑎𝑡𝑖𝑜𝑛_𝑡𝑖𝑚e}}$$
效率公式可表达如下:
