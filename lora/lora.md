...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;未来工作可以从以下几个方向展开：<br>
- 可以将LoRA与其他高效的自适应方法相结合，可能提供正交的改进。
- 微调或LoRA背后的机制还远未清楚——在预训练期间学习的特征如何转化为在下游任务上表现良好？我们认为相比完全微调，LoRA使得回答这个问题更加可行。
- 我们大多数情况下依靠启发式方法来选择应用LoRA的权重矩阵。是否有更加原则性的方法来处理这个问题？
